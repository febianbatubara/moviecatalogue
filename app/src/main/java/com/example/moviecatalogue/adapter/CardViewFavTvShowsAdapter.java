...
public class CardViewFavTvShowsAdapter extends RecyclerView.Adapter<CardViewFavTvShowsAdapter.CardViewViewHolder> {
    private ArrayList<TvShow> listTvShow;

    public CardViewFavTvShowsAdapter(ArrayList<TvShow> list) {
    ...
    @NonNull
    @Override
    public CardViewFavTvShowsAdapter.CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_cardview_tv_show, parent, false);
        return new CardViewFavTvShowsAdapter.CardViewViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CardViewFavTvShowsAdapter.CardViewViewHolder holder, int position) {
